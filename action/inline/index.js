...
composer.on('inline_query', async ({ inlineQuery, answerInlineQuery }) => {
    let results = [], indexation = 1, base = `https://github.com/chiseldevs/`, thumb = `https://github.com/chiseldevs/westman/raw/master/assets/repo.png`
    let repos = await Object.values(await ds("https://api.github.com/orgs/chiseldevs/repos")).map(function (obj) { return obj["name"]})
